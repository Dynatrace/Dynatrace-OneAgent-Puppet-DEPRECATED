...
class ruxit_agent (
  ...
  if (!empty($ruxit_required_version) and $ruxit_required_version != '0.0.0.0' and $::ruxit_installed_version == '0.0.0.0' and 
  $::oneagent_installed_version == '0.0.0.0') {
    ...
    ruxit_agent::resources::install_ruxit_agent { 'install_ruxit_agent': required_version => $ruxit_required_version } ->
